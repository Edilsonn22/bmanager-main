  ...
  return (
    <div className="flex-1 h-screen overflow-auto p-7 py-6 bg-gray-50">
      ...
      <div className="bg-white rounded-md p-5 text-gray-900 mb-7">
        <div>
          <h3 className="font-semibold text-gray-900 mb-">Demostracao de Resultados</h3>
          <div>
            <p className="text-gray-500 text-md mb-4 ">Analise Financeira Detalhada</p>
          </div>

          <div className="bg-green-100 rounded-2xl p-4 mb-4">
            <h2 className="">Receitas de Vendas </h2>
          </div>
          ...
          <div className="bg-blue-100 rounded-2xl p-4 font-bold">
            <h2>Lucro Liquido</h2>
          </div>
        </div>
      </div>
