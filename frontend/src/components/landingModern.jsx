      ...
      <section data-reveal className="landing-reveal relative z-10 bg-slate-950 py-16 text-white sm:py-24">
        <div className="mx-auto grid max-w-7xl gap-12 px-4 sm:px-6 lg:grid-cols-[.8fr_1.2fr] lg:items-center lg:px-8 2xl:max-w-[1536px]">
          ...
          <div className="grid gap-3 sm:grid-cols-2">
            {modulos.map(([Icon, titulo, texto]) => <article key={titulo} className="rounded-2xl border border-white/10 bg-white/[.06] p-5 backdrop-blur"><span className="grid size-10 place-items-center rounded-xl bg-indigo-400/15 text-indigo-300"><Icon size={20} /></span><h3 className="mt-4 font-bold">{titulo}</h3><p className="mt-2 text-sm leading-6 text-slate-400">{texto}</p></article>)}
          </div>
        </div>
      </section>
