...
function RegistarSaida(){
    ...
    const novaQuantidade = Number(produtoSelecionado.quantidade) - Number(quantidade);
    useEffect(() => {
        if (produtoSelecionado && quantidade) {
            fetch("http://localhost/bmanager/backend/saida/registrar.php", {
                method: "POST",
                headers: {
            ...
            .then((data) => {
                if (data.sucesso) {
                    ...
                    alert("Erro ao registrar saída: " + data.erro);
                }
            })
            .catch((err) => {
